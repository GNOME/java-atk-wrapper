...
jaw_hypertext_data_init (jobject ac)
{
	...
	jmethodID jmid = (*jniEnv)->GetMethodID(jniEnv, classHypertext, "createAtkHypertext", "(Ljavax/accessibility/AccessibleContext;)Lorg/GNOME/Accessibility/AtkHypertext");
	jobject jatk_hypertext = (*jniEnv)->CallObjectMethod(jniEnv, classHypertext, jmid, ac);
