...
jaw_image_data_init (jobject ac)
{
	...
	jmethodID jmid = (*jniEnv)->GetMethodID(jniEnv, classImage, "createAtkImage", "(Ljavax/accessibility/AccessibleContext;)Lorg/GNOME/Accessibility/AtkImage");
	jobject jatk_image = (*jniEnv)->CallObjectMethod(jniEnv, classImage, jmid, ac);
